...
class BItemLoader(ItemLoader):
    ...
    percent_recommend = MapCompose(strip_html, trim_whitespace)
    pros = MapCompose(strip_html, trim_whitespace)
    cons = MapCompose(strip_html, trim_whitespace)
    best_uses = MapCompose(strip_html, trim_whitespace)
